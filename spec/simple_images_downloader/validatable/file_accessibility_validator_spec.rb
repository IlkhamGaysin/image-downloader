...
RSpec.describe SimpleImagesDownloader::Validatable::FileAccessibilityValidator do
  describe '#validate' do
    ...
    it 'does not raise an error for a readable file' do
      ...
      expect { validator.validate(file.path) }.not_to raise_error
      file.unlink
    end
    ...
    it 'raises a PermissionsError for an unreadable file' do
      ...
      expect { validator.validate(file.path) }.to raise_error(SimpleImagesDownloader::Errors::PermissionsError)
      file.unlink
    end
  end
end
